    ...
    <Box className='bg-white lg:pt-[120px] pb-10 lg:pb-20 relative z-10 capitalize'>
      <footer>
        <Grid container columnGap={0} display='flex' direction='right' justifyContent='center'>
          ...
          {/* column-1 */}
          <Grid item xs={2}>
            <h4 className='text-dark text-xl font-semibold mb-9'>Company</h4>
            <ul>
              <li>
                <NavLink to='/about' className='inline-block text-base text-body-color hover:text-primary leading-loose mb-2'>About V2L</NavLink>
              </li>
              <li>
                <NavLink to='/support' className='inline-block text-base text-body-color hover:text-primary leading-loose mb-2'>Support</NavLink>
              </li>
            </ul>
          </Grid>
          ...
          {/* column-2 */}
          <Grid item xs={2}>
            <h4 className='text-dark text-xl font-semibold mb-9'>publisher</h4>
            <ul>
              <li>
                <NavLink to='/publisher-login' className='inline-block text-base text-body-color hover:text-primary leading-loose mb-2'>Sign-In</NavLink>
              </li>
              <li>
          ...
          <Grid item xs={2}>
            {/* column-3 */}
            <h4 className='text-dark text-xl font-semibold mb-9'>Follow Us On</h4>
            <div className='flex items-center mb-6'>
              <NavLink
                to='/homepage'
                className='w-8 h-8 flex items-center justify-center rounded-full border border-[#E5E5E5] text-dark hover:text-white hover:bg-primary hover:border-primary mr-3 sm:mr-4 lg:mr-3
                     xl:mr-4'><svg width='8' height='16' viewBox='0 0 8 16' className='fill-current'>
                  <path
